...
const { string, boolean } = require('abstract-things/values');
 ...
 * power strips.
 */
module.exports = Appliance.capability(Appliance => class extends Appliance.with(PowerChannels, RestorableState) {
